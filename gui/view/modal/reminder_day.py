...
from .elements.reminder_day import ReminderDay
from utils.handlers.math import UtilityCalculator
from config import Config

class ReminderDayModal(QDialog, LoggerMixin):
    ...
    def __init_modal(self):
        ...
        main_layout.addWidget(self.day_view, 1)
        
    def load_day_data(self, reminders: list[CalendarData]):
        
        self.day_view.update_reminders(reminders)
