...
class AddReturnablePackagingModal(QDialog, LoggerMixin):
    ...
    def __init_modal(self):
        ...
        self.label_manufacture_number = QLabel("Bottle number:")
    ...
    async def get_form_data(self) -> ReturnablePackagingData:
        ...
        try:
            ...
            possible_row_id = await queries.select_next_possible_row_returned_packaging_id()
            
            data.id = possible_row_id
            
            qr_data = {data.id, StorageItemTypeEnum.RETURNABLE_PACKAGING}
            ...
            file_name = f"packaging_{possible_row_id}_{safe_name}.png"
