...
class AddToolsModal(QDialog, LoggerMixin):
    ...
    async def get_form_data(self) -> ToolsData:
        ...
        try:
            ...
            possible_row_id = await queries.select_next_possible_row_tool_id()
            
            data.id = possible_row_id
            
            qr_data = {data.id, StorageItemTypeEnum.TOOL}
            ...
            file_name = f"szerszam_{possible_row_id}_{safe_name}.png"
