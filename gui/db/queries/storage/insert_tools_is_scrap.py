...
class insert_tools_is_scrap(AsyncQueryBase):
    # Scrap tool is deducted from stock and inserted as a new item with is_scrap flag,
    ...
    async def query(self, 
        ...
        await self.update_remaining_tools_reference_quantity(
    ...
    async def update_remaining_tools_reference_quantity(self, 
        quantity: float,
        storage_id: int,
        manufacture_number: str,
        inspection_date: datetime
        ...
        await self.session.execute(
            update(
                ...
                and_(
                    ...
                    example_db.tool.storage_id == storage_id,
                    example_db.tool.manufacture_number == manufacture_number
                )
